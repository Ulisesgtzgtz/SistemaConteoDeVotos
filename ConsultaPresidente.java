 ...
 * @author lenov
 */
@WebServlet(urlPatterns = {"/ConsultaPresidente"})
public class ConsultaPresidente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            rs = state.executeQuery("SELECT C.nombre,sum(CC.votosCasilla) FROM casilla_has_candidatos CC INNER JOIN candidatos C ON C.idCandidato = CC.idCandidato WHERE C.puesto = 'Presidente' GROUP BY CC.idCandidato;");
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaDiputados.class.getName()).log(Level.SEVERE, null, ex);
        }
