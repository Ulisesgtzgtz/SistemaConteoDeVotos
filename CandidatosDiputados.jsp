<%-- 
    Document   : CandidatosDiputados
    Created on : 22/06/2021, 02:00:13 AM
    Author     : lenov
--%>
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <title>Diputados Registro</title>
    ...
    <body>
        ...
        <h1>Diputados</h1>
        <form action = 'http://localhost:8080/SistemaConteoDeVotos/VotosDiputados' method = 'post'>
            <table border = "1">
                <tr>
                <td>ID de Casilla
